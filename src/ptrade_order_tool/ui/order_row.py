...
class OrderRow(QWidget):
    ...
    def __init__(self, order: OrderDraft, parent: QWidget | None = None, *, read_only: bool = False) -> None:
        ...
        self.delete_button = QPushButton("删除", parent=self)
        ...
        value_row = QWidget(parent=self)
        self.value_layout = QHBoxLayout(value_row)
        self.value_layout.setContentsMargins(0, 0, 0, 0)
        self.value_layout.setSpacing(4)
        self.price_label = QLabel(f"价格 {ORDER_CONDITIONS[order.order_type]}", parent=value_row)
        ...
        self.shares_label = QLabel("股数", parent=value_row)
